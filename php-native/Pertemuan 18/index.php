...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="print.php">Print to PDF</a>
          </li>
  ...
  <div class="container">
    ...
    <form action="" method="post" class="d-flex">
      <input class="form-control me-2" name="keyword" type="text" placeholder="Search..." autofocus autocomplete="off" id="keyword">
